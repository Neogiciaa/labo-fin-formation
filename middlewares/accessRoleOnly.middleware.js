...
//TODO actuellement un copier/coller de accessUserOnly -> Revoir la logique entièrement pour l'adapter aux rôles !
...
const accesOwnHouseOnly = (options = {userOnly : true}) => {
    ...
    return async (req, res, next) => {
        ...
        if (options.userOnly && tokenData.id === req.params.id) {
...
module.exports = accesOwnHouseOnly;
